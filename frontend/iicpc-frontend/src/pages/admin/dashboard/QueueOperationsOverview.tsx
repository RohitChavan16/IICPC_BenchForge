    ...
    >
      ...
      <div className="p-5 grid grid-cols-2 lg:grid-cols-3 gap-6 z-10 flex-1">
        ...
        <div className="space-y-3">
          ...
          <div className="h-2 w-full overflow-hidden rounded-full bg-slate-100 dark:bg-slate-800">
            <motion.div 
              initial={{ width: 0 }} animate={{ width: '30%' }} transition={{ duration: 1, delay: 0.6 }}
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-baseline gap-2">
            <motion.span 
              ...
              className="text-3xl font-bold text-slate-900 dark:text-slate-100"
            >3</motion.span>
            <span className="text-xs font-medium text-slate-500">in last hour</span>
          </div>
          <div className="h-2 w-full overflow-hidden rounded-full bg-slate-100 dark:bg-slate-800">
            <motion.div 
              initial={{ width: 0 }} animate={{ width: '10%' }} transition={{ duration: 1, delay: 0.8 }}
